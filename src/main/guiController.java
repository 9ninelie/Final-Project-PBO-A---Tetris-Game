...
import logic.event.eventSource;
import logic.event.eventTipe;
    ...
    public Paint getFillColor(int i){
        ...
        switch (i){
            case 0:
                ...
                break;
            case 1:
                returnPaint = Color.rgb(102, 0, 0);
                break;
            case 2:
                returnPaint = Color.rgb(51, 0, 102);
                break;
            case 3:
                returnPaint = Color.rgb(0, 102, 0);
                break;
            case 4:
                returnPaint = Color.rgb(204, 204, 0);
                break;
            case 5:
                returnPaint = Color.rgb(204, 102, 0);
                break;
            case 6:
                returnPaint = Color.DARKBLUE;
                break;
            case 7:
                returnPaint = Color.DARKKHAKI;
                break;
            default:
                returnPaint = Color.TRANSPARENT;
                break;
...
//PAUSE LOGIC
        ...
        pausebutton.selectedProperty().addListener(new ChangeListener<Boolean>() {
            ...
            public void changed(ObservableValue<? extends Boolean> observableValue, Boolean oldValue, Boolean newValue) {
                Image imagePause = new Image(getClass().getResourceAsStream("/resources/image/resumebutton.png"));
                Image imageResume =new Image(getClass().getResourceAsStream("/resources/image/pausebutton.png"));
                final ImageView pencet = new ImageView();
                pencet.setFitWidth(94);
                pencet.setFitHeight(47);
                if (newValue){
                    pausebutton.setGraphic(pencet);
                    pencet.imageProperty().set(imagePause);
                    timeline.pause();
                } else {
                    pausebutton.setGraphic(pencet);
                    pencet.imageProperty().set(imageResume);
                    timeline.play();
                }
            }
        });
